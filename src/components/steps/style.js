...
const StepsStyle = Styled(Steps)`
    ...
    .ant-steps-item.ant-steps-item-finish .ant-steps-item-container::after{
        background-image: url(${require('../../static/img/blue-dot-step-finish.png')}) !important;
        left: 82% !important;  
    }
    ...
    .ant-steps-item .ant-steps-item-container::after{
        background-image: url(${require('../../static/img/blue-dot-step-inactive.png')}) !important;
        left: 80% !important;  
    }
    .ant-steps-item.ant-steps-item-active .ant-steps-item-icon {
        background-color: var(--El-Salvador-Blue, #041E5F) !important;
        color: #FFF !important;
        .ant-steps-icon {
            color: #FFF !important;
        }
    ...
    .ant-steps-item.ant-steps-item-finish .ant-steps-item-icon {
        background: rgb(0, 66, 168) !important;
        border: 2px solid rgb(0, 66, 168) !important;
    }
