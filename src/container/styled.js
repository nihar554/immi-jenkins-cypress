...
const BasicFormWrapper = Styled.div`
 ...
 .ant-input, .ant-select-selector, .ant-picker{
  ...
  #changePassword_oldPass, #changePassword_newPass, #changePassword_confirmPass{
    ...
    .ant-picker{
       ...
       .division{
        ...
        margin-bottom:15px;
        width:100%;
        border-bottom:1px solid rgba(47, 50, 65, 0.3);
       }
       .ant-row{
        padding-bottom:15px;
       }
